 ...
 ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control-file btn btn-danger " value="<?php echo $image; ?>" name="image" required />
                            
                        </div>
                    </div>
                    <div class="form-group row mt-2">
                        <div class="offset-sm-2 col-sm-10">
                            <button class="btn btn-outline-primary w-100" name="update">Update Student</button>
    ...
    if (isset($_POST['update'])) {
        ...
        if ($insert_pro) {
            echo "<script>alert('Welcome, You just updated student')</script>";
