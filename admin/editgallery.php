...
?>
     ...
     ?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="<?php echo $gallery_title; ?>" name="imagetitle" />
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control-file btn btn-danger " name="image" />
                            
                        </div>
                    </div>
                    <div class="form-group row mt-2">
                        <div class="offset-sm-2 col-sm-10">
                            <button class="btn btn-outline-primary w-100" name="update">Update Image</button>
    ...
    if (isset($_POST['update'])) {
        ...
        $image_tnp =$_FILES['u_image']['tnp_name'];

        if (empty($u_image)) {
            $u_image = $u_imagea;

        }else{
            $u_image = 'Gallerying'.date('Y-m-d-H-i-s').'_'.uniqid() . 'jpg';
        }


        

        move_uploaded_file($image_tnp, "../images/gallery/$u_image");
        ...
        if ($insert_pro) {
            echo "<script>alert('Welcome, You just updated a new image')</script>";
