...
if ($_GET['id']) {
    ...
    $term = "SELECT * FROM salary WHERE id = '$edit_id' ";
 ...
 ?>
                <div class="row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="<?php echo $staff_name; ?>" name="staff_name" />
    ...
    if (isset($_POST['update'])) {
        ...
        if ($insert_pro) {
            echo "<script>alert('Welcome, You just updated Salary')</script>";
