                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h2 class="text-center text-white bg-primary">View  Student Clases</h2>
                    <div align="right">
                    ...
                    <table class="table table-bordered table-success" id="table2excel">
                        ...
                        <tbody>
                            <?php 
                                $class = "SELECT * FROM class ORDER BY class_id DESC";
                                $runclass = mysqli_query($conn,$class);
                                $i=0;

                                while ($rowclass = mysqli_fetch_array($runclass)): {
                                    $id = $rowclass['class_id'];
                                    $name = $rowclass['classname'];
                                    $class = $rowclass['classoption'];
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href="viewclass.php?del=<?php echo $id; ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php }; ?>
