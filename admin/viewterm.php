...
?>
    ...
    $del_query = "DELETE FROM term WHERE id ='$del_id' ";
     ...
     ?>
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered table-success" id="table2excel">
                        ...
                        <tbody>
                            <?php 
                                $term = "SELECT * FROM term ORDER BY id DESC";
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo ucfirst($termname); ?></td>
                                    <td>
                                        <a class="btn btn-warning" href="editterm.php?id=<?php echo $id; ?>"><i class="fa fa-pencil-square-o"></i></a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" href="viewterm.php?del=<?php echo $id; ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php }; ?>
