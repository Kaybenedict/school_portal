                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h2 class="text-center text-white bg-primary">View Subject Details</h2>
                    <div align="right">
                    ...
                    <table class="table table-bordered table-success" id="table2excel">
                        ...
                        <tbody>
                            <?php 
                                $subject = "SELECT * FROM subject ORDER BY id DESC";
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo ucfirst($subjectname); ?></td>
                                    <td>
                                        <a class="btn btn-warning" href="editsubject.php?id=<?php echo $id; ?>"><i class="fa fa-pencil-square-o"></i></a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" href="viewsubject.php?del=<?php echo $id; ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php }; ?>
