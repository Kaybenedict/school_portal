                    ...
                    <div class="modal-content">
                        ...
                        <form action="insertcode.php" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>Number</label>
                                    <input type="number" name="number" class="form-control" placeholder="Enter Question Number">
                                ...
                                <div class="modal-footer">
                                        ...
                                        <button type="submit" name="insertdata" class="btn btn-primary">Submit Question</button>
                                      </div>
                                </form>
                                ...
                                <?php
                                 ...
                                 <tbody>
                                   ...
                                   <!-- </td>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href="addexam.php?del=<?php echo $id; ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
