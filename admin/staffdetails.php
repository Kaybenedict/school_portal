                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center text-white bg-primary">Staff Details</h2>
                ...
                <div class="col-md-4">
                    <div class="card mb-3" style="max-width: 540px;">
                      <div class="row no-gutters">
                        <div class="col-md-4">
                          <img src="../admin/images/student/sch.jpg" width="100%" class="image-fluid" alt="...">
                        </div>
                        <div class="col-md-8">
                          <div class="card-body">
                            <h5 class="card-title bg-dark text-white">Benedict</h5>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row mt-1">
                            <div class="offset-sm-6 col-sm-6">
                                <button class="btn btn-danger" name="addfees">Add Fees</button>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <table class="table table-bordered table-condensed">
                        <thead>
                            <tr>
                                <th class="bg-dark text-white">2022-03-29 20:32:16</th>
                                <th>Benedict</th>
                                <th>Benedict</th>
                            </tr>
