                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h2 class="text-center text-white bg-primary">Applicants Page</h2>
                    <div align="right">
                    ...
                    <table class="table table-bordered table-success" id="table2excel">
                        ...
                        <tbody>
                            <?php 
                                $term = "SELECT * FROM admission ORDER BY id DESC";
                                ...
                                while ($rowterm = mysqli_fetch_array($runterm)): {
                                    ...
                                    $name = $rowterm['name'];
                                    $email = $rowterm['email'];
                                    $mobile = $rowterm['mobile'];
                                    $class = $rowterm['class'];
                                    $former = $rowterm['former'];
                                    $i++;
