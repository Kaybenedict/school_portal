                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h2 class="text-center text-white bg-primary">View Fees Details</h2>
                    <div align="right">
                        ...
                        <tbody>
                            <?php 
                                ...
                                while ($rowfee = mysqli_fetch_array($runfee)): {
                                    ...
                                    $class = $rowfee['class'];
                                    $fees = $rowfee['fees'];
                                    $purpose = $rowfee['purpose'];
                                    $session = $rowfee['session'];
                                    $date = $rowfee['date'];
                                    $i++;
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ucfirst($fees); ?></td>
                                    <td><?php echo ucfirst($purpose); ?></td>
                                    <td><?php echo ucfirst($session); ?></td>
                                    <td><?php echo ucfirst($date); ?></td>
                                    <td>
                                        <a class="btn btn-warning" href="editfee.php?id=<?php echo $id; ?>"><i class="fa fa-pencil-square-o"></i></a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" href="viewfee.php?del=<?php echo $id; ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php }; ?>
