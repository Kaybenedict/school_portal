...
if ($_GET['id']) {
    ...
    $fee = "SELECT * FROM fee WHERE id = '$edit_id' ";
    $runfee=mysqli_query($conn,$fee);
    $row = mysqli_fetch_array($runfee);
 ...
 ?>
                <div class="row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-danger">Fee</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" value="<?php echo $fees; ?>" name="fees" />
                            
                        </div>
                    </div>
                     <div class="form-group row">
                        <label class="col-sm-2 col-form-label text-danger">Purpose</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="<?php echo $purpose; ?>" name="purpose" />
