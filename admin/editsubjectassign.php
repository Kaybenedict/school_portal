...
if ($_GET['id']) {
    ...
    $subject = "SELECT * FROM assignsubject WHERE id = '$edit_id' ";
 ...
 ?>
                <div class="row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="<?php echo $staffname; ?>" name="staff_name" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="<?php echo $classoption; ?>" name="classoption" />
    ...
    if (isset($_POST['update'])) {
        ...
        $update = "UPDATE assignsubject SET 
